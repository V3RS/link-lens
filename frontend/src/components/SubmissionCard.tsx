...
const SubmissionCard = ({
  ...
  const renderThumbnail = () => {
    switch (status) {
      case 'complete':
        ...
        return <div className="flex items-center justify-center h-full input-bg rounded-lg">
            <ImageOffIcon size={48} className="text-secondary" />
          </div>;
      case 'no image found':
        return <div className="flex flex-col items-center justify-center h-full input-bg rounded-lg p-4">
        ...
        return <div className="flex items-center justify-center h-full input-bg rounded-lg">
            <div className="animate-pulse flex space-x-4">
              <div className="flex-1 space-y-4 py-1">
                <div className="h-4 button-bg rounded w-3/4"></div>
                <div className="space-y-2">
                  <div className="h-4 button-bg rounded"></div>
                  <div className="h-4 button-bg rounded w-5/6"></div>
                </div>
              </div>
            </div>
          </div>;
  ...
  return <div className={`card-bg rounded-lg overflow-hidden ${isLatest ? 'border-theme border' : 'border border-transparent'} shadow-md`}>
      <div className="p-4">
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center">
            <div className="input-bg p-2 rounded-md mr-3">
            ...
            <div>
              ...
              {title && <p className="text-sm text-secondary mt-1 line-clamp-1">
                  {title}
                </p>}
            </div>
          </div>
